# havana_block
havana_block is a collection of utilities for interacting with Web3 and Ethereum smart contracts.
...
You can havana_block Project via npm:

```bash
npm install havana_block
```
## Usage

const Web3Tools = require('havana_block');
